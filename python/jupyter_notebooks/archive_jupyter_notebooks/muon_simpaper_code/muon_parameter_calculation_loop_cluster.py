...
simtel_dir="/home/users/v/voitsekh/scratch/muon_paper/simtel/work/north/lst/output/"
simtel_files="run*_muon_lst.simtel.gz"
...
for single_file in glob.glob(simtel_dir+simtel_files): 
    ...
    writer = HDF5TableWriter("/home/users/v/voitsekh/scratch/muon_paper/ctapipe_processing/output/lst/" + outfile, "muons", mode="w")
